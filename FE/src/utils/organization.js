...
export function normalizeEnterpriseName(value = "") {
...
export function inferEnterpriseFromBranch(branchName = "") {
...
export function getBranchOptionsByEnterprise(enterpriseName = "") {
...
export function getStationsForEnterpriseBranch(enterpriseName = "", branchName = "") {
